...
PKG_NAME="astra-treasury-protocol-v0.1.1-public-refresh"
...
cp -a services/public-refresh "$STAGE/services-public-refresh"
cp -a services/docs "$STAGE/services-docs"
