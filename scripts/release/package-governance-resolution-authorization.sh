...
PKG_NAME="astra-treasury-protocol-v0.1.1-governance-resolution-authorization"
...
cp -a configs/full-launch-governance-resolution-authorization.config.json "$STAGE/"
cp -a docs/full-launch-governance-resolution-authorization "$STAGE/docs-full-launch-governance-resolution-authorization"
cp -a services/full-launch-governance-resolution-authorization "$STAGE/services-full-launch-governance-resolution-authorization"
cp -a scripts/validate-full-launch-governance-resolution-authorization.mjs "$STAGE/"
cp -a public-docs/full-launch-governance-resolution-authorization.html "$STAGE/"
cp -a public-docs/full-launch-governance-resolution-authorization-status.json "$STAGE/"
