...
PKG_NAME="astra-treasury-protocol-v0.1.1-treasury-funding-readiness"
...
cp -a configs/treasury-funding-readiness.config.json "$STAGE/"
cp -a docs/treasury-funding "$STAGE/docs-treasury-funding"
cp -a services/treasury-funding "$STAGE/services-treasury-funding"
cp -a scripts/validate-treasury-funding-readiness.mjs "$STAGE/"
cp -a public-docs/treasury-funding.html "$STAGE/"
cp -a public-docs/treasury-funding-status.json "$STAGE/"
