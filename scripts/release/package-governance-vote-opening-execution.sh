...
PKG_NAME="astra-treasury-protocol-v0.1.1-governance-vote-opening-execution"
...
cp -a configs/full-launch-governance-vote-opening-execution.config.json "$STAGE/"
cp -a docs/full-launch-governance-vote-opening-execution "$STAGE/docs-full-launch-governance-vote-opening-execution"
cp -a services/full-launch-governance-vote-opening-execution "$STAGE/services-full-launch-governance-vote-opening-execution"
cp -a scripts/validate-full-launch-governance-vote-opening-execution.mjs "$STAGE/"
cp -a public-docs/full-launch-governance-vote-opening-execution.html "$STAGE/"
cp -a public-docs/full-launch-governance-vote-opening-execution-status.json "$STAGE/"
