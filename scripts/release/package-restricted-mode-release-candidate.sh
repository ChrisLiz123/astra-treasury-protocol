...
PKG_NAME="astra-treasury-protocol-v0.1.1-restricted-mode-release-candidate"
...
cp -a configs/restricted-mode-release-candidate.config.json "$STAGE/"
cp -a docs/restricted-mode-release-candidate "$STAGE/docs-restricted-mode-release-candidate"
cp -a services/restricted-mode-release-candidate "$STAGE/services-restricted-mode-release-candidate"
cp -a scripts/validate-restricted-mode-release-candidate.mjs "$STAGE/"
cp -a public-docs/restricted-mode-release-candidate.html "$STAGE/"
cp -a public-docs/restricted-mode-release-candidate-status.json "$STAGE/"
