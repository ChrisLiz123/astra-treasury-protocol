...
PKG_NAME="astra-treasury-protocol-v0.1.1-public-package-inventory"
...
cp -a public-docs/packages.html "$STAGE/"
cp -a public-docs/package-inventory.json "$STAGE/"
cp -a services/docs/generate-public-package-inventory.mjs "$STAGE/"
