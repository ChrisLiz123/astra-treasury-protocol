...
PKG_NAME="astra-treasury-protocol-v0.1.1-dex-pool-creation-readiness"
...
cp -a configs/dex-pool-creation-readiness.config.json "$STAGE/"
cp -a docs/dex-pool-creation-readiness "$STAGE/docs/dex-pool-creation-readiness"
cp -a services/dex-pool-creation-readiness "$STAGE/services-dex-pool-creation-readiness"
cp -a scripts/validate-dex-pool-creation-readiness.mjs "$STAGE/"
cp -a public-docs/dex-pool-creation-readiness.html "$STAGE/"
cp -a public-docs/dex-pool-creation-readiness-status.json "$STAGE/"
