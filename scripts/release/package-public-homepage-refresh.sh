...
PKG_NAME="astra-treasury-protocol-v0.1.1-public-homepage-refresh"
...
cp -a services/homepage "$STAGE/services-homepage"
cp -a public-docs/index.html "$STAGE/"
cp -a public-docs/home-status.json "$STAGE/"
