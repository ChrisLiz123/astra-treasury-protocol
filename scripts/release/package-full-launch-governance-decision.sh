...
PKG_NAME="astra-treasury-protocol-v0.1.1-full-launch-governance-decision"
...
cp -a configs/full-launch-governance-decision.config.json "$STAGE/"
cp -a docs/full-launch-governance "$STAGE/docs-full-launch-governance"
cp -a services/full-launch-governance "$STAGE/services-full-launch-governance"
cp -a scripts/validate-full-launch-governance-decision.mjs "$STAGE/"
cp -a public-docs/full-launch-governance.html "$STAGE/"
cp -a public-docs/full-launch-governance-status.json "$STAGE/"
