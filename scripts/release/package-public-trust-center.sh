...
PKG_NAME="astra-treasury-protocol-v0.1.1-public-trust-center"
...
cp -a services/trust-center "$STAGE/services-trust-center"
cp -a public-docs/trust.html "$STAGE/"
cp -a public-docs/trust-status.json "$STAGE/"
cp -a docs/trust/TRUST_CENTER.md "$STAGE/"
