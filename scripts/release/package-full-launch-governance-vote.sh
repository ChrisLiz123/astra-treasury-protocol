...
PKG_NAME="astra-treasury-protocol-v0.1.1-full-launch-governance-vote"
...
cp -a configs/full-launch-governance-vote.config.json "$STAGE/"
cp -a docs/full-launch-governance-vote "$STAGE/docs-full-launch-governance-vote"
cp -a services/full-launch-governance-vote "$STAGE/services-full-launch-governance-vote"
cp -a scripts/validate-full-launch-governance-vote.mjs "$STAGE/"
cp -a public-docs/full-launch-governance-vote.html "$STAGE/"
cp -a public-docs/full-launch-governance-vote-status.json "$STAGE/"
