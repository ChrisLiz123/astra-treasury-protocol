...
PKG_NAME="astra-treasury-protocol-v0.1.1-evidence-archive"
...
cp -a services/evidence "$STAGE/services-evidence"
cp -a public-docs/evidence.html "$STAGE/"
cp -a public-docs/evidence-index.json "$STAGE/"
