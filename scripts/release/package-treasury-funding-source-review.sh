...
PKG_NAME="astra-treasury-protocol-v0.1.1-treasury-funding-source-review"
...
cp -a configs/treasury-funding-source-review.config.json "$STAGE/"
cp -a docs/treasury-source "$STAGE/docs-treasury-source"
cp -a services/treasury-source "$STAGE/services-treasury-source"
cp -a scripts/validate-treasury-funding-source-review.mjs "$STAGE/"
cp -a public-docs/treasury-source.html "$STAGE/"
cp -a public-docs/treasury-source-status.json "$STAGE/"
