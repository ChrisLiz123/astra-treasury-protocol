...
PKG_NAME="astra-treasury-protocol-v0.1.1-restricted-launch-stabilization"
...
cp -a configs/restricted-launch-stabilization.config.json "$STAGE/"
cp -a services/stabilization "$STAGE/services-stabilization"
cp -a docs/stabilization "$STAGE/docs-stabilization"
cp -a public-docs/stabilization.html "$STAGE/"
cp -a public-docs/stabilization-status.json "$STAGE/"
