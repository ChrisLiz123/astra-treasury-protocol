...
PKG_NAME="astra-treasury-protocol-v0.1.1-dex-liquidity-funding-transfer-post-execution-balances"
...
cp -a configs/dex-liquidity-funding-transfer-post-execution-balances.config.json "$STAGE/"
cp -a docs/dex-liquidity-funding-transfer-post-execution-balances "$STAGE/docs/dex-liquidity-funding-transfer-post-execution-balances"
cp -a services/dex-liquidity-funding-transfer-post-execution-balances "$STAGE/services-dex-liquidity-funding-transfer-post-execution-balances"
cp -a scripts/verify-dex-liquidity-funding-transfer-post-execution-balances.mjs "$STAGE/"
cp -a scripts/validate-dex-liquidity-funding-transfer-post-execution-balances.mjs "$STAGE/"
cp -a public-docs/dex-liquidity-funding-transfer-post-execution-balances.html "$STAGE/"
cp -a public-docs/dex-liquidity-funding-transfer-post-execution-balances-status.json "$STAGE/"
...
cp -a reports/dex-liquidity-funding-transfer-post-execution-balances/dex-liquidity-funding-transfer-post-execution-balances-status.json "$STAGE/evidence/" 2>/dev/null || true
cp -a reports/dex-liquidity-funding-transfer-safe-execution-live/dex-liquidity-funding-transfer-safe-execution-live-record.json "$STAGE/evidence/"
...
if find "$STAGE" -type f | grep -E "(liquidity-added|position-minted|public-trading-live|private|secret|keystore)"; then
  echo "STOP: DEX funding-transfer post-execution balance package contains liquidity/public/private artifacts."
  exit 1
fi
