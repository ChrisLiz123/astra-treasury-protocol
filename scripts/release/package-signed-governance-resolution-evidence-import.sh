...
PKG_NAME="astra-treasury-protocol-v0.1.1-signed-governance-resolution-evidence-import"
...
cp -a services/signed-governance-resolution-evidence "$STAGE/services-signed-governance-resolution-evidence"
cp -a scripts/validate-signed-governance-resolution-evidence.mjs "$STAGE/"
cp -a public-docs/signed-governance-resolution-evidence.html "$STAGE/"
cp -a public-docs/signed-governance-resolution-evidence-status.json "$STAGE/"
