...
PKG_NAME="astra-treasury-protocol-v0.1.1-dex-liquidity-parameter-finalization-review"
...
cp -a configs/dex-liquidity-parameter-finalization-review.config.json "$STAGE/"
cp -a docs/dex-liquidity-parameter-finalization "$STAGE/docs/dex-liquidity-parameter-finalization"
cp -a services/dex-liquidity-parameter-finalization "$STAGE/services-dex-liquidity-parameter-finalization"
cp -a scripts/validate-dex-liquidity-parameter-finalization-review.mjs "$STAGE/"
cp -a public-docs/dex-liquidity-parameter-finalization.html "$STAGE/"
cp -a public-docs/dex-liquidity-parameter-finalization-status.json "$STAGE/"
