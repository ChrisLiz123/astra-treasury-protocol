...
PKG_NAME="astra-treasury-protocol-v0.1.1-public-market-data"
...
cp -a services/market "$STAGE/services-market"
cp -a public-docs/market.html "$STAGE/"
cp -a public-docs/market-status.json "$STAGE/"
cp -a docs/token/ASTRATOKEN_MARKET_DATA.md "$STAGE/"
