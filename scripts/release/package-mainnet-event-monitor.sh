...
PKG_NAME="astra-treasury-protocol-v0.1.1-mainnet-event-monitor"
...
cp -a services/mainnet-event-monitor "$STAGE/services-mainnet-event-monitor"
cp -a public-docs/mainnet-events.html "$STAGE/"
cp -a public-docs/mainnet-event-monitor-status.json "$STAGE/"
