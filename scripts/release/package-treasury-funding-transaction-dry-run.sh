...
PKG_NAME="astra-treasury-protocol-v0.1.1-treasury-funding-transaction-dry-run"
...
cp -a configs/treasury-funding-transaction-dry-run.config.json "$STAGE/"
cp -a docs/treasury-transaction "$STAGE/docs-treasury-transaction"
cp -a services/treasury-transaction-dry-run "$STAGE/services-treasury-transaction-dry-run"
cp -a scripts/validate-treasury-funding-transaction-dry-run.mjs "$STAGE/"
cp -a public-docs/treasury-transaction-dry-run.html "$STAGE/"
cp -a public-docs/treasury-transaction-dry-run-status.json "$STAGE/"
