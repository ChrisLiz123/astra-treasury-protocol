...
PKG_NAME="astra-treasury-protocol-v0.1.1-governance-vote-authorization"
...
cp -a configs/full-launch-governance-vote-authorization.config.json "$STAGE/"
cp -a docs/full-launch-governance-vote-authorization "$STAGE/docs-full-launch-governance-vote-authorization"
cp -a services/full-launch-governance-vote-authorization "$STAGE/services-full-launch-governance-vote-authorization"
cp -a scripts/validate-full-launch-governance-vote-authorization.mjs "$STAGE/"
cp -a public-docs/full-launch-governance-vote-authorization.html "$STAGE/"
cp -a public-docs/full-launch-governance-vote-authorization-status.json "$STAGE/"
