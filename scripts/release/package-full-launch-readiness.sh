...
PKG_NAME="astra-treasury-protocol-v0.1.1-full-launch-readiness"
...
cp -a configs/full-launch-readiness.config.json "$STAGE/"
cp -a docs/full-launch "$STAGE/docs-full-launch"
cp -a services/full-launch "$STAGE/services-full-launch"
cp -a scripts/validate-full-launch-readiness.mjs "$STAGE/"
cp -a public-docs/full-launch.html "$STAGE/"
cp -a public-docs/full-launch-status.json "$STAGE/"
