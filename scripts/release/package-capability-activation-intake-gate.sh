...
PKG_NAME="astra-treasury-protocol-v0.1.1-capability-activation-intake-gate"
...
cp -a configs/capability-activation-intake.config.json "$STAGE/"
cp -a docs/capability-activation-intake "$STAGE/docs/capability-activation-intake"
cp -a services/capability-activation-intake "$STAGE/services-capability-activation-intake"
cp -a scripts/validate-capability-activation-intake.mjs "$STAGE/"
cp -a public-docs/capability-activation-intake.html "$STAGE/"
cp -a public-docs/capability-activation-intake-status.json "$STAGE/"
