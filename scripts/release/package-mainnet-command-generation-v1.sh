...
PKG_NAME="astra-treasury-protocol-v0.1.1-mainnet-command-generation-v1"
...
cp -a docs/mainnet-live/MAINNET_DEPLOYMENT_COMMANDS_V1.md "$STAGE/"
cp -a docs/mainnet-live/MAINNET_DEPLOYMENT_DRY_RUN_V1.md "$STAGE/" 2>/dev/null || true
cp -a scripts/generate-mainnet-deployment-commands-v1.mjs "$STAGE/"
cp -a scripts/deploy-base-mainnet-guarded.ts "$STAGE/"
