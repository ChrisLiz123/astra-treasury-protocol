...
PKG_NAME="astra-treasury-protocol-v0.1.1-public-disclosure-update"
...
cp -a configs/public-disclosure-update.config.json "$STAGE/"
cp -a docs/disclosures "$STAGE/docs-disclosures"
cp -a services/disclosures "$STAGE/services-disclosures"
cp -a scripts/validate-public-disclosure-update.mjs "$STAGE/"
cp -a public-docs/disclosures.html "$STAGE/"
cp -a public-docs/disclosures-status.json "$STAGE/"
