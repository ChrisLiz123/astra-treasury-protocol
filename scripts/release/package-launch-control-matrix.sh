...
PKG_NAME="astra-treasury-protocol-v0.1.1-launch-control-matrix"
...
cp -a configs/launch-control.config.json "$STAGE/"
cp -a docs/launch-control "$STAGE/docs-launch-control"
cp -a services/launch-control "$STAGE/services-launch-control"
cp -a scripts/validate-launch-control.mjs "$STAGE/"
cp -a public-docs/launch-control.html "$STAGE/"
cp -a public-docs/launch-control-status.json "$STAGE/"
