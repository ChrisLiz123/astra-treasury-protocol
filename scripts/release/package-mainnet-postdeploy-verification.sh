...
PKG_NAME="astra-treasury-protocol-v0.1.1-mainnet-postdeploy-verification"
...
cp -a docs/mainnet-live/MAINNET_POSTDEPLOY_VERIFICATION_V1.md "$STAGE/"
cp -a scripts/mainnet-postdeploy-check-v1.ts "$STAGE/"
