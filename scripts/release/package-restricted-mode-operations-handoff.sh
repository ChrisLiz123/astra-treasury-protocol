...
PKG_NAME="astra-treasury-protocol-v0.1.1-restricted-mode-operations-handoff"
...
cp -a configs/restricted-mode-operations-handoff.config.json "$STAGE/"
cp -a docs/restricted-mode-operations-handoff "$STAGE/docs/restricted-mode-operations-handoff"
cp -a services/restricted-mode-operations-handoff "$STAGE/services-restricted-mode-operations-handoff"
cp -a scripts/validate-restricted-mode-operations-handoff.mjs "$STAGE/"
cp -a public-docs/restricted-mode-operations-handoff.html "$STAGE/"
cp -a public-docs/restricted-mode-operations-handoff-status.json "$STAGE/"
...
cp -a release/astra-treasury-protocol-v0.1.1-restricted-mode-final-release.tar.gz "$STAGE/evidence/" 2>/dev/null || true
cp -a release/astra-treasury-protocol-v0.1.1-restricted-mode-final-release.tar.gz.sha256 "$STAGE/evidence/" 2>/dev/null || true
