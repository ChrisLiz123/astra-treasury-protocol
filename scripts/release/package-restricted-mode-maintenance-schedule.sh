...
PKG_NAME="astra-treasury-protocol-v0.1.1-restricted-mode-maintenance-schedule"
...
cp -a configs/restricted-mode-maintenance-schedule.config.json "$STAGE/"
cp -a docs/restricted-mode-maintenance-schedule "$STAGE/docs/restricted-mode-maintenance-schedule"
cp -a services/restricted-mode-maintenance-schedule "$STAGE/services-restricted-mode-maintenance-schedule"
cp -a scripts/validate-restricted-mode-maintenance-schedule.mjs "$STAGE/"
cp -a public-docs/restricted-mode-maintenance-schedule.html "$STAGE/"
cp -a public-docs/restricted-mode-maintenance-schedule-status.json "$STAGE/"
