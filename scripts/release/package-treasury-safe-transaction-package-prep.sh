...
PKG_NAME="astra-treasury-protocol-v0.1.1-treasury-safe-transaction-package-prep"
...
cp -a configs/treasury-safe-transaction-package.config.json "$STAGE/"
cp -a docs/treasury-safe-transaction "$STAGE/docs-treasury-safe-transaction"
cp -a services/treasury-safe-transaction "$STAGE/services-treasury-safe-transaction"
cp -a scripts/validate-treasury-safe-transaction-package.mjs "$STAGE/"
cp -a public-docs/treasury-safe-transaction.html "$STAGE/"
cp -a public-docs/treasury-safe-transaction-status.json "$STAGE/"
