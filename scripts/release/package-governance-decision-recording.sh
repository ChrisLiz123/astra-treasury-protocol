...
PKG_NAME="astra-treasury-protocol-v0.1.1-governance-decision-recording"
...
cp -a configs/full-launch-governance-decision-recording.config.json "$STAGE/"
cp -a docs/full-launch-governance-decision-recording "$STAGE/docs-full-launch-governance-decision-recording"
cp -a services/full-launch-governance-decision-recording "$STAGE/services-full-launch-governance-decision-recording"
cp -a scripts/validate-full-launch-governance-decision-recording.mjs "$STAGE/"
cp -a public-docs/full-launch-governance-decision-recording.html "$STAGE/"
cp -a public-docs/full-launch-governance-decision-recording-status.json "$STAGE/"
