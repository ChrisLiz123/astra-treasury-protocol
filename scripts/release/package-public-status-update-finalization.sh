...
PKG_NAME="astra-treasury-protocol-v0.1.1-public-status-update-finalization"
...
cp -a docs/public-status-update "$STAGE/docs-public-status-update"
cp -a services/public-status-update "$STAGE/services-public-status-update"
