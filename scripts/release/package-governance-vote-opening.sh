...
PKG_NAME="astra-treasury-protocol-v0.1.1-governance-vote-opening"
...
cp -a configs/full-launch-governance-vote-opening.config.json "$STAGE/"
cp -a docs/full-launch-governance-vote-opening "$STAGE/docs-full-launch-governance-vote-opening"
cp -a services/full-launch-governance-vote-opening "$STAGE/services-full-launch-governance-vote-opening"
cp -a scripts/validate-full-launch-governance-vote-opening.mjs "$STAGE/"
cp -a public-docs/full-launch-governance-vote-opening.html "$STAGE/"
cp -a public-docs/full-launch-governance-vote-opening-status.json "$STAGE/"
