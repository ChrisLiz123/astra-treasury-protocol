...
PKG_NAME="astra-treasury-protocol-v0.1.1-incident-acknowledgement"
...
cp -a services/incident-tracker "$STAGE/services-incident-tracker"
cp -a docs/mainnet-live/INCIDENT_ACKNOWLEDGEMENT_WORKFLOW.md "$STAGE/" 2>/dev/null || true
cp -a public-docs/incidents.html "$STAGE/"
cp -a public-docs/incident-summary.json "$STAGE/"
