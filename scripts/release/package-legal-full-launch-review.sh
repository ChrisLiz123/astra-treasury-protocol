...
PKG_NAME="astra-treasury-protocol-v0.1.1-legal-full-launch-review"
...
cp -a configs/legal-full-launch-review.config.json "$STAGE/"
cp -a docs/legal-full-launch "$STAGE/docs-legal-full-launch"
cp -a services/legal-full-launch "$STAGE/services-legal-full-launch"
cp -a scripts/validate-legal-full-launch-review.mjs "$STAGE/"
cp -a public-docs/legal-full-launch.html "$STAGE/"
cp -a public-docs/legal-full-launch-status.json "$STAGE/"
