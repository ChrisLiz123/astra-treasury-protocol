...
PKG_NAME="astra-treasury-protocol-v0.1.1-mainnet-live-status"
...
cp -a public-docs/live.html "$STAGE/"
cp -a public-docs/live-status.json "$STAGE/"
cp -a docs/mainnet-live/MAINNET_LIVE_STATUS.md "$STAGE/"
cp -a scripts/generate-mainnet-live-status.mjs "$STAGE/"
