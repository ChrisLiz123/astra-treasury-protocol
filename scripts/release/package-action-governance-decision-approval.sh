...
PKG_NAME="astra-treasury-protocol-v0.1.1-action-governance-decision-approval"
...
cp -a docs/action-approvals/governance-decision "$STAGE/docs-action-governance-decision"
cp -a services/action-approval "$STAGE/services-action-approval"
cp -a scripts/validate-action-approval-governance-decision.mjs "$STAGE/"
cp -a public-docs/governance-decision-approval.html "$STAGE/"
cp -a public-docs/governance-decision-approval-status.json "$STAGE/"
