...
PKG_NAME="astra-treasury-protocol-v0.1.1-governance-resolution-signing"
...
cp -a configs/full-launch-governance-resolution.config.json "$STAGE/"
cp -a docs/full-launch-governance-resolution "$STAGE/docs-full-launch-governance-resolution"
cp -a services/full-launch-governance-resolution "$STAGE/services-full-launch-governance-resolution"
cp -a scripts/validate-full-launch-governance-resolution.mjs "$STAGE/"
cp -a public-docs/full-launch-governance-resolution.html "$STAGE/"
cp -a public-docs/full-launch-governance-resolution-status.json "$STAGE/"
