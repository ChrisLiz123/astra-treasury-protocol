...
PKG_NAME="astra-treasury-protocol-v0.1.1-mainnet-production-config"
...
cp -a docs/mainnet-live "$STAGE/docs-mainnet-live"
cp -a configs/mainnet-production.config.template.json "$STAGE/"
cp -a scripts/validate-mainnet-production-config.mjs "$STAGE/"
