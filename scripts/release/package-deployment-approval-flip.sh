...
PKG_NAME="astra-treasury-protocol-v0.1.1-deployment-approval-flip"
...
cp -a docs/mainnet-final/DEPLOYMENT_APPROVAL_FLIP_PROCEDURE.md "$STAGE/"
cp -a docs/mainnet-final/DEPLOYMENT_APPROVAL_SESSION_CHECKLIST.md "$STAGE/"
cp -a scripts/set-mainnet-deployment-approval.mjs "$STAGE/"
