...
PKG_NAME="astra-treasury-protocol-v0.1.1-dex-liquidity-source-safe-impact-approval"
...
cp -a configs/dex-liquidity-source-safe-impact-approval.config.json "$STAGE/"
cp -a docs/dex-liquidity-source-safe-impact "$STAGE/docs/dex-liquidity-source-safe-impact"
cp -a services/dex-liquidity-source-safe-impact "$STAGE/services-dex-liquidity-source-safe-impact"
cp -a scripts/record-dex-liquidity-source-safe-impact-approval.mjs "$STAGE/"
cp -a scripts/validate-dex-liquidity-source-safe-impact-approval.mjs "$STAGE/"
cp -a public-docs/dex-liquidity-source-safe-impact.html "$STAGE/"
cp -a public-docs/dex-liquidity-source-safe-impact-status.json "$STAGE/"

cp -a reports/dex-liquidity-source-safe-impact/dex-liquidity-source-safe-impact-approval-record.json "$STAGE/evidence/" 2>/dev/null || true
