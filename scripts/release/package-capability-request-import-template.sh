...
PKG_NAME="astra-treasury-protocol-v0.1.1-capability-request-import-template"
...
cp -a configs/capability-request-import.config.json "$STAGE/"
cp -a docs/capability-request-import "$STAGE/docs/capability-request-import"
cp -a services/capability-request-import "$STAGE/services-capability-request-import"
cp -a scripts/import-capability-activation-request.mjs "$STAGE/"
cp -a scripts/validate-capability-request-import.mjs "$STAGE/"
cp -a public-docs/capability-request-import.html "$STAGE/"
cp -a public-docs/capability-request-import-status.json "$STAGE/"
