...
PKG_NAME="astra-treasury-protocol-v0.1.1-safe-transaction-payloads-v1"
...
cp -a docs/mainnet-live/SAFE_TRANSACTION_PAYLOADS_V1.md "$STAGE/"
cp -a scripts/generate-safe-transaction-payloads-v1.mjs "$STAGE/"
