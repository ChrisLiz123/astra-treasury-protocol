...
PKG_NAME="astra-treasury-protocol-v0.1.1-dex-liquidity-path-selection"
...
cp -a configs/dex-liquidity-path-selection.config.json "$STAGE/"
cp -a docs/dex-liquidity-path "$STAGE/docs/dex-liquidity-path"
cp -a services/dex-liquidity-path "$STAGE/services-dex-liquidity-path"
cp -a scripts/validate-dex-liquidity-path-selection.mjs "$STAGE/"
cp -a public-docs/dex-liquidity-path.html "$STAGE/"
cp -a public-docs/dex-liquidity-path-status.json "$STAGE/"
